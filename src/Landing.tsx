...
function Landing({ uploadedImageCallback }: LandingProps) {
  ...
  return (
    <div className="landing-view-container flex flex-col items-center justify-between sm:pt-4 lg:pt-8">
      <div className="max-w-7xl">
        <p className="font-pixilify text-base md:text-lg lg:text-2xl 2xl:text-2xl font-semibold p-text-shadow text-center">
          ...
          securely. It combines powerful image manipulation tools with a simple
          interface for experimenting with digital secrecy.
        </p>
        <ImageDropzone
      ...
      <div className="max-w-7xl bg-white/10 text-black px-3 py-3 rounded flex items-center gap-4 xl:px-6 xl:gap-6">
        <div className="text-red-600 text-6xl p-text-shadow">!</div>
        <p className="font-pixilify text-white text-left p-text-shadow xl:text-lg">
